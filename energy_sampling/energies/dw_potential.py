...
from utils import remove_mean, compute_distances

from .base_set import BaseSet



class MultiDoubleWellPotential(BaseSet):
    ...
    def __init__(self, device, dim = 8, n_particles = 4, a = 0.9, b = -4, c = 0, offset = 4, data_path = None): 
        super().__init__()
        self._dim = dim
    ...
    def energy(self, x):
        x = x.contiguous()
        dists = compute_distances(x, self._n_particles, self._n_dims)
